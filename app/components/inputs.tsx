...
export const InputDefault: React.FC<InputProps> = ({
  ...
  <div className='w-full'>
    ...
    <input defaultValue={defaultValue} id={id} {...register(id, { required })} placeholder={placeholder}
...
export const InputDate: React.FC<InputProps> = ({
  ...
  <div className='w-full'>
    ...
    <div className="relative w-full">
      ...
      <input defaultValue={defaultValue} type="date" id={id} {...register(id, { required })} className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full ps-10 p-2.5 outline-none " />
    </div>
